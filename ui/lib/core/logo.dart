...
class NcLogo extends StatelessWidget {
  const NcLogo({Key? key}) : super(key: key);

  static const logoSvg = '''
  <svg xmlns="http://www.w3.org/2000/svg" width="292" height="256.907" viewBox="0 0 292 256.907">
    <g id="Logo" transform="translate(0 2)">
      <text id="_ねこで_" data-name="―ねこで―" transform="translate(137 246.907)" font-size="29" font-family="DelaGothicOne-Regular, Dela Gothic One" letter-spacing="0.034em"><tspan x="-66.091" y="0">―ねこで―</tspan></text>
      <text id="necodeIT" transform="translate(146 199.907)" font-size="55" font-family="Orbitron" letter-spacing="0.034em"><tspan x="-145.888" y="0">necodeIT</tspan></text>
